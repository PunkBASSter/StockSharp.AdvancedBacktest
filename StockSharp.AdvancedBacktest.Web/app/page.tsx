                        ...
                        <div className="rounded-lg border border-gray-200 bg-white p-6 shadow-sm dark:border-gray-800 dark:bg-gray-900">
                            ...
                            {!loading && !error && chartData && (
                                <div className="mt-4 space-y-6">
                                    ...
                                    {chartData.walkForward?.windows && chartData.walkForward.windows.length > 0 && (
                                        <>
                                            <div>
                                                <h3 className="mb-2 text-lg font-medium text-gray-800 dark:text-gray-200">
                                                    Walk-Forward Analysis
                                                </h3>
                                                <WFComparisonChart windows={chartData.walkForward.windows} />
                                            </div>
                                            ...
                                            <div>
                                                ...
                                                <WFTimeline windows={chartData.walkForward.windows} />
                                            </div>
                                        </>
                                    )}
                                </div>
