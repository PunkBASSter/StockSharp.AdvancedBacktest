...
public class DzzPeakTroughLauncher : IStrategyLauncher
{
    public string Name => "DzzPeakTrough";
    ...
    public async Task<int> RunAsync(RunFlags flags)
    {
        ...
        Console.WriteLine("=== DzzPeakTrough Strategy Backtest ===");
        Console.WriteLine();
        ...
        try
        {
            ...
            var strategy = new DzzPeakTroughStrategy
            {
                Security = security,
                Portfolio = portfolio,
            ...
            using var runner = new BacktestRunner<DzzPeakTroughStrategy>(config, strategy, metricsCalculator);
            ...
            if (result.IsSuccessful)
            {
                ...
                var reportBuilder = new ReportBuilder<DzzPeakTroughStrategy>();
