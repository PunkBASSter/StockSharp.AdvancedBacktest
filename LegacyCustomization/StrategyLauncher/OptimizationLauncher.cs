...
using StockSharp.Samples.MaCrossoverBacktester.Reporting;
...
{
	private readonly TrainingPeriodConfig _trainingPeriod;
	...
	private readonly ICustomOptimizer<TStrategy> _optimizer;
	...
	public OptimizationLauncher(TrainingPeriodConfig trainingPeriod, ICustomOptimizer<TStrategy> customOptimizer)
		: base()
	{
